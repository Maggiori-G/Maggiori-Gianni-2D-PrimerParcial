...
namespace VistaAerolinea {
	public partial class FrmInformesClientes:Form {
		...
		private void FrmInformesClientes_Load(object sender,EventArgs e) {
			dgw_dataClientes.DataSource=Sistema.ListaClientes;
		}
		...
		private void Limpiar() {
			...
			dgw_dataClientes.DataSource=null;
			dgw_dataClientes.DataSource=Sistema.ListaClientes;
		}
		...
		private void btn_modificar_Click(object sender,EventArgs e) {
			...
			FrmNuevoCliente frmNuevoCliente=new FrmNuevoCliente((Cliente)dgw_dataClientes.CurrentRow.DataBoundItem);
			frmNuevoCliente.ShowDialog();
			if( frmNuevoCliente.DialogResult==DialogResult.OK) {
				if(frmNuevoCliente.NuevoCliente is not null) {
		...
		private void txt_buscar_TextChanged(object sender,EventArgs e) {
			...
			dgw_dataClientes.DataSource=auxListaClientes;
		}

		private void btn_eliminarCliente_Click(object sender,EventArgs e) {
			Cliente? auxCliente = dgw_dataClientes.CurrentRow.DataBoundItem as Cliente;
		...
		private void btn_seleccionarCliente_Click(object sender,EventArgs e) {
			listaClienteSeleccionado!.Add((Cliente)dgw_dataClientes.CurrentRow.DataBoundItem);
